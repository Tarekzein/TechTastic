<aside id="logo-sidebar" class="fixed top-0 left-0 z-20 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            <li>
                <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <li>
                <x-responsive-nav-link href="#" :active="request()->routeIs('')" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            ...
            <li>
                <x-responsive-nav-link href="{{ route('posts.show') }}" :active="request()->routeIs('posts.show')" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <li>
                <x-responsive-nav-link href="#" :active="request()->routeIs('')" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <x-responsive-nav-link href="{{ route('logout') }}" @click.prevent="$root.submit();" :active="request()->routeIs('')" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
